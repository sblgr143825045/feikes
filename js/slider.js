...
Slider.prototype.createUI = function(){
	...
	ulDom.style.cssText = "position:absolute;list-style:none;right:30px;bottom:10px;z-index:1;";
	...
	for(let i=0;i<this.imgs.length;i++){
		...
		liDom.innerHTML = i+1;
		liDom.style.color = "#cbbca8"
		liDom.style.fontSize = 8 + "px";
		liDom.style.lineHeight = this.btnHeight+"px";
		liDom.style.textIndent = (this.btnWidth-8)/2 + "px";
		liDom.style.border = " 1px solid gray";
		if(this.isCircle){
