...
Slider.prototype.createUI = function(){
	...
	//ul li	
	htmlstr='<ul style="position:absolute;list-style:none;right:50px;height:20px;bottom:10px;z-index:1;">';
	for(let i=0;i<this.imgs.length;i++){
		htmlstr+= '<li style="margin-right:20px;float:left;color:#cbbca8;font-size:8px;width:28px;height:20px';
		htmlstr+='width:'+this.btnWidth+"px;";
		htmlstr+='height:'+this.btnHeight+"px;";
		htmlstr+='lineheight:'+this.btnHeight+"px;";
		htmlstr+='textIndent:'+this.btnWidth/2 + "px;";
		// htmlstr+='border:' 1px solid gray;
		if(this.isCircle){
