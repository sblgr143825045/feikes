<?php
	...
	while($query_row){
		$str = $str.'{ "goodsId":"'.$query_row[0].'","goodsName":"'.$query_row[1].'","goodsPrice":"'.$query_row[2].'","goodsCount":"'.$query_row[3].'","goodsDesc":"'.$query_row[4].'","goodsImg":"'.$query_row[5].'"}';
